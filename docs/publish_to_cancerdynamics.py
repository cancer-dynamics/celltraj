...
PUBLISHED_SUBDIR = Path("public") / "docs" / "celltraj"
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Build/copy celltraj Sphinx docs into the cancerdynamics.org "
            "Astro website repo."
        )
    )
    parser.add_argument(
...
def main() -> int:
    ...
    print(f"Copied celltraj docs to {target}")
    print("Website URL after the Astro site is deployed:")
    print("  https://cancerdynamics.org/docs/celltraj/")
